...
?>
 ...
 <div class="container pt-3">
        ...
        <div class="rows justify-content-between" style="gap: 10px;">
    <div class="col-6 col-md-3 cards ind py-3">
        <a href="products.php#watch">
            <img src="images/watch.jpg" class="img-fluid" alt="" style="border-radius:0.5rem">
    ...
    <div class="col-6 col-md-3 cards py-3">
...
<script>
$(document).ready(function(){//تفعيل فتح النوافذ عند الحاجه
  $('[data-toggle="popover"]').popover();
});
$(document).ready(function() {//فتح نافة التسجيل عن وجود جزء من الرابط يحتوي على #login
...
<?php if (isset($_GET['error'])) {$z = $_GET['error'];//يعرض  نافذه اذا كان هناك خطأ signup
...
<?php if (isset($_GET['errorl'])) {$z = $_GET['errorl'];//يعرض  نافذه اذا كان هناك خطأ login
    echo "<script type='text/javascript'>
$(document).ready(function(){
$('#login').modal('show');
});
