...
<div class="container" style="margin-top:65px">
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2 zoom">
            <div class="card">
                <img src="images/watch1.jpg" alt="" class="img-fluid pb-1" >
                <a href="product_details.php#1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                ...
                <a href="product_details.php#2" >
                <div class="figure-caption">
                    <h6>Panerai Radiomir</h6>
                    <h6>Price : 6000 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/watch3.jpg" alt="" class="img-fluid pb-1">                <a href="product_details.php#vv" >
                <a href="product_details.php#3" >
                <div class="figure-caption">
                    <h6>Panerai Luminor</h6>
                    <h6>Price : 4700 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/watch4.jpg" alt="" class="img-fluid pb-1">                <a href="product_details.php#vv" >
                <a href="product_details.php#4" >
                <div class="figure-caption">
                    <h6>Nomos Glashütte</h6>
                    <h6>Price : 2100 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    ...
                    <a href="product_details.php#5" >
                    <div class="figure-caption">
                    <h6>Polyester Hoodie</h6>
                    <h6>Price : 9.99 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/shirt2.jpg" alt="" class="img-fluid pb-1" >                <a href="product_details.php#vv" >
                    <a href="product_details.php#6" >
                    <div class="figure-caption">
                    <h6>Adidas t-shirt</h6>
                    <h6>Price : 9 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="shoes" >
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        ...
                        <a href="product_details.php#12" >
                        <div class="figure-caption">
                        <h6>Nike Brown Sneaker </h6>
                    <h6>Price : 20 jd</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
