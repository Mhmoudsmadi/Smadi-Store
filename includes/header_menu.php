...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(40, 136, 196,0.5)">
            <div class="container">
                    <a  class="logo"><img src="images/logo.png" alt=""  width =35px ></a>
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">  Smadi Store</a>
              ...
              <form action="signup_script.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="validation1">Full Name</label>
                        <input type="text" class="form-control" id="validation1" name="firstName" placeholder="Full Name" required>
                    </div>
                    <div class="form-group col-md -6">
                        <label for="validation2">Phone Number</label>
                        <input type="text" class="form-control" id="validation2" name="lastName" placeholder="Phone Number">
                    </div>
                </div>
